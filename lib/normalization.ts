...
export function canonical(value: string) {
  ...
  const aliases:Record<string,string>={'ms dynamics':'Microsoft Dynamics 365','ms dynamics crm':'Microsoft Dynamics 365','ms crm':'Microsoft Dynamics 365','powerbi':'Power BI','node js':'Node.js','react js':'React'};
